...
#define TERM_KEY_ESCAPE					(_KEY_INIT(0x1B))		// Exception execute command symbol
...
#include <printf.h>
extern void mt_printf(const char* format, ...);
#define CLI_Printf          mt_printf
#if (ECHO_EN == 1)
//#define CLI_PutChar		TUSART_PutChar
#define CLI_PutChar(C)		mt_printf("%c", C)
#else	// ECHO_EN != 1
#define CLI_PutChar
#endif	// ECHO_EN == 1
