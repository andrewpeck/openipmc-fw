...
static char*    board_manufacturer  = "SPRACE-KIT";
static char*    board_product_name  = "OpenIPMC-HW";
...
void get_product_and_board_info( board_and_product_info_t* info )
{
	...
	info->board_part_number           =  board_part_number;
	...
	info->product_serial_number       =  product_serial_number;
	info->product_asset_tag           =  product_asset_tag;
