 ...
 *
 * Power Levels are controlled by OpenIPMC and this function is called when
 * a Power Level transition is triggered.
 *
 * This function needs to be customized according to the board characteristic.
 */
void board_specific_activation_policy( uint8_t current_power_level, uint8_t new_power_level )
{

	/*
	 * For customization, 'current_power_level' and 'new_power_level' can be used to improve
	 * the transitions between power levels.
	 */
