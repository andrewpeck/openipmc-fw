...
static const linear_sensor_constants_t pim400_voltage_consts =
{
  .sensor_type          = VOLTAGE,
  .unit_type            = VOLTS,
  .lower_nonrecoverable = (1000 * PIM400_VOLTAGE_LOWER_NONCRITICAL) / 325,
  .lower_critical       = (1000 * PIM400_VOLTAGE_LOWER_CRITICAL) / 325,
  .lower_noncritical    = (1000 * PIM400_VOLTAGE_LOWER_NONRECOVERABLE) / 325,
  .upper_noncritical    = (1000 * PIM400_VOLTAGE_UPPER_NONCRITICAL) / 325,
  .upper_critical       = (1000 * PIM400_VOLTAGE_UPPER_CRITICAL) / 325,
  .upper_nonrecoverable = (1000 * PIM400_VOLTAGE_UPPER_NONRECOVERABLE) / 325,
  .m                    = PIM400_VOLTAGE_M,
  .b                    = PIM400_VOLTAGE_B,
  .re                   = PIM400_VOLTAGE_E,
  .be                   = 0
